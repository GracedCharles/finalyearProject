  ...
  useEffect(() => {
    const fetchUserProfile = async () => {
      try {
        ...
        // If the user has a driver license number, fetch their stats
        if (profile.driverLicenseNumber) {
          try {
            const stats = await driverApi.getDashboardStats(profile.driverLicenseNumber);
            ...
            <View className="items-center">
              <Text className="text-lg font-bold text-gray-900">
                {loadingStats ? (
                  ...
                  driverStats ? `MKW${driverStats.totalPaid.toLocaleString()}` : 'MKW0'
                )}
              </Text>
            ...
            <View className="items-center">
              <Text className="text-lg font-bold text-gray-900">
                {loadingStats ? (
                  ...
                  driverStats ? driverStats.totalOutstanding : '0'
                )}
              </Text>
